...
#define KEYMAP( \
    ...
    K0A, K0B, K0C,           K0F,                K0J, K0K,      K0M, K0N,                     \
) { \
...
/* 2 */   { KC_##K2A, KC_##K2B, KC_##K2C, KC_##K2D, KC_##K2E, KC_##K2F, KC_##K2G, KC_##K2H, KC_##K2I, KC_##K2J, KC_##K2K, KC_##K2L, KC_NO,    KC_##K2N, KC_NO,    KC_##K2P, KC_NO   }, \
...
/* 0 */   { KC_##K0A, KC_##K0B, KC_##K0C, KC_NO,    KC_NO,    KC_##K0F, KC_NO,  KC_NO,    KC_NO,    KC_##K0J, KC_##K0K, KC_NO,    KC_##K0M, KC_##K0N, KC_NO,    KC_NO,    KC_NO   } \
}
